            ...
            <div class="col-md-5">
                <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 form-floating">
                        <input type="text" name="title" class="form-control" id="title" placeholder="Il nome della Rosa" required>
                    ...
                    <div class="mb-3 form-floating nr_pages_width">
                        <input type="number" name="page_count" class="form-control" id="pages" placeholder="10" min="1">
